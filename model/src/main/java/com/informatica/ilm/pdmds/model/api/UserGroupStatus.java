...
public enum UserGroupStatus implements InfaMessageEnum {

    ACTIVE("UGS_001", "ACTIVE"),

    PASSIVE("UGS_002", "PASSIVE");

    private UserGroupStatus(String messageCode, String messageKey) {
    ...
    public static String getText(UserGroupStatus description) {
        return getText(description, Locale.getDefault(), (Object[]) null);
    }

    public static String getText(UserGroupStatus description, Object... args) {
        return getText(description, Locale.getDefault(), args);
    }

    public static String getText(UserGroupStatus description, Locale locale, Object... args) {
        try {
    ...
    public static boolean isAvailable(UserGroupStatus description) {
        try {
